...
impl Language {
    ...
    /// rulogman colours a `.yml` as. The inner half — the user's own definitions
    /// ahead of the ten rulogman ships, and a user file replacing a shipped one
    ...
    /// The language of `lower` among the seven that ship with rulogman.
