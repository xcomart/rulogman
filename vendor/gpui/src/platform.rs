...
pub trait PlatformWindow: HasWindowHandle + HasDisplayHandle {
    ...
    /// RULOGMAN PATCH: switches an existing window between a transparent
    /// (app-drawn) title bar and the one the platform draws, without
    /// recreating the window. gpui settles this at creation time, from
    /// `TitlebarOptions::appears_transparent`, and offers no way back.
    ///
