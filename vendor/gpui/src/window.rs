...
impl Window {
    ...
    /// RULOGMAN PATCH: switches the open window between a transparent title
    /// bar the app draws itself and the caption the platform draws, without
    /// reopening it.
    ///
    ...
    /// caption belongs to the compositor until the window opts into
    /// client-side decorations — this does nothing, and
    /// [`Window::request_decorations`] is the call that has an effect.
