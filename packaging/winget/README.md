...
```powershell
winget validate --manifest packaging\winget\0.5.5
```
...
```powershell
winget install --manifest packaging\winget\0.5.5
```
...
```powershell
$dst = "<fork>\manifests\x\Xcomart\Rulogman\0.5.5"
New-Item -ItemType Directory -Force $dst
Copy-Item packaging\winget\0.5.5\*.yaml $dst
```
